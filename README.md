...
3)Access http://localhost/Upload-multiple-files-from-a-folderand send your feedback .

4)select files folder [Or Put all your files in "file" folder]  and click upload.Enjoy!!!
